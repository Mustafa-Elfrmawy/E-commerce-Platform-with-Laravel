    ...
    public function ruleValidate(Request $request, string $status)
    {
        $rulesMap = [
            ...
            'storeProduct' => [
                ...
                'barcode' => 'required|unique:products,barcode|numeric|digits_between:8,60',
            ...
            'updateProduct' => [
                'title' => 'required|string|max:255',
                'slug' => 'required|string|max:255|unique:products,slug,'.$request->input('id').'id',
                'sku' => 'required|string|max:100|unique:products,sku,'.$request->input('id').'id',
                'barcode' => 'required|numeric|digits_between:8,60|unique:products,barcode,'.$request->input('id').'id',
