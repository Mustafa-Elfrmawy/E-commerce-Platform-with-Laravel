<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="{{ route('user.changePassword.create') }}"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-lock"></i> Change Password</a>
    </li>
    <li class="nav-item">
