...
@if (Session::has('successRegister'))
    <div
        class="alert alert-success alert-dismissible fade show shadow rounded px-4 py-3 mb-4 border border-success position-relative">
...
@if (Session::has('successChangePassword'))
    <div
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h5 class="mb-1 fw-bold text-success">successChangePassword</h5>
                <div class="text-dark">
