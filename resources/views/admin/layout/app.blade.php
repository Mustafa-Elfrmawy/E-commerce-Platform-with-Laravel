...
<body class="hold-transition sidebar-mini">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
                            <img src="{{ my_asset('admin-asset/img/avatar5.png') }}" class="img-circle elevation-2"
    ...
    <!-- Scripts -->
    <script src="{{ my_asset('admin-asset/plugins/jquery/jquery.min.js') }}"></script>
    <script src="{{ my_asset('admin-asset/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ my_asset('admin-asset/plugins/dropzone/min/dropzone.min.js') }}"></script>
    <script src="{{ my_asset('admin-asset/js/adminlte.min.js') }}"></script>
    <script src="{{ my_asset('admin-asset/js/demo.js') }}"></script>
    <script src="{{ my_asset('admin-asset/plugins/summernote/summernote.min.js') }}"></script>
